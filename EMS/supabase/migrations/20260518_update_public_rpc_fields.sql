-- Migration: Update public inquiry RPC to include approved employment, personal details, and salary info
CREATE OR REPLACE FUNCTION get_public_personnel_data(p_emp_no TEXT, p_last_name TEXT)
RETURNS JSONB AS $$
DECLARE
  v_personnel JSONB;
BEGIN
  -- Get Personnel Info (Filtered for Privacy, including Employment & Personal/Contact details, and salary parameters)
