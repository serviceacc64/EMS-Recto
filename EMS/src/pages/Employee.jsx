...
const Employee = () => {
  ...
  useEffect(() => {
    if (isModalOpen && editingIndex === null) {
      ...
      sessionStorage.setItem("employee_draft", JSON.stringify(draftData));
    }
  ...
  const handleAdd = () => {
    const savedDraft = sessionStorage.getItem("employee_draft");
    if (savedDraft) {
      try {
  ...
  const handleSubmit = async (e) => {
    ...
    if (editingIndex !== null) {
      ...
      sessionStorage.removeItem("employee_draft");
    }
              ...
              <form onSubmit={handleSubmit} className="flex flex-col">
                <div className="grid grid-cols-1 gap-6 mb-8">
                  ...
                  <div className="flex flex-col bg-surface-alt border border-border-subtle rounded-[16px] p-5 md:p-6 shadow-sm transition-colors duration-300">
                    ...
                    {/* Leave Balances */}
                    <h3 className="text-text-main text-[13px] mb-4 font-bold border-t border-border-subtle pt-4 flex items-center justify-between">
